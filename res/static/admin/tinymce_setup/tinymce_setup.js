...
tinyMCE.init({
    ...
    plugins: 'advimage,advlink,autosave,charmap,code,fullscreen,paste,media,searchreplace,grappelli,template',
    ...
    theme_advanced_blockformats: 'p,h1,h2,h3,h4,pre,div,span',
