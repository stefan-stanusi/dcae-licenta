...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.attributions'
        db.add_column('members_member', 'attributions',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.attributions'
        db.delete_column('members_member', 'attributions')
    ...
    models = {
        ...
        'members.member': {
            ...
            'attributions': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
