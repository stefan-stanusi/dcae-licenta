...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.ro_url'
        db.add_column('courses_course', 'ro_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.ro_url'
        db.delete_column('courses_course', 'ro_url')
    ...
    models = {
        ...
        'courses.course': {
            ...
            'r': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'courses'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['rooms.Room']"}),
