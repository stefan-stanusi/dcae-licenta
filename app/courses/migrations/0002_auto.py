...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field r on 'Course'
        db.create_table('courses_course_r', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('course', models.ForeignKey(orm['courses.course'], null=False)),
            ('room', models.ForeignKey(orm['rooms.room'], null=False))
        ))
        db.create_unique('courses_course_r', ['course_id', 'room_id'])


    def backwards(self, orm):
        # Removing M2M table for field r on 'Course'
        db.delete_table('courses_course_r')
    ...
    models = {
        ...
        'courses.course': {
            ...
            'r': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['rooms.Room']", 'null': 'True', 'blank': 'True'}),
