...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('labs_laboratory', (
            ...
            ('m', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='mlabs', null=True, to=orm['master.Programme'])),
        ...
        # Adding M2M table for field r on 'Laboratory'
        db.create_table('labs_laboratory_r', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('laboratory', models.ForeignKey(orm['labs.laboratory'], null=False)),
            ('room', models.ForeignKey(orm['rooms.room'], null=False))
        ))
        db.create_unique('labs_laboratory_r', ['laboratory_id', 'room_id'])

        # Adding M2M table for field coordinators on 'Laboratory'
        db.create_table('labs_laboratory_coordinators', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('laboratory', models.ForeignKey(orm['labs.laboratory'], null=False)),
            ('member', models.ForeignKey(orm['members.member'], null=False))
        ))
        db.create_unique('labs_laboratory_coordinators', ['laboratory_id', 'member_id'])

        # Adding M2M table for field people on 'Laboratory'
        db.create_table('labs_laboratory_people', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('laboratory', models.ForeignKey(orm['labs.laboratory'], null=False)),
            ('member', models.ForeignKey(orm['members.member'], null=False))
        ))
        db.create_unique('labs_laboratory_people', ['laboratory_id', 'member_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field r on 'Laboratory'
        db.delete_table('labs_laboratory_r')

        # Removing M2M table for field coordinators on 'Laboratory'
        db.delete_table('labs_laboratory_coordinators')

        # Removing M2M table for field people on 'Laboratory'
        db.delete_table('labs_laboratory_people')
