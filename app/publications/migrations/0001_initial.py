...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Genre'
        db.create_table('publications_genre', (
        ...
        db.send_create_signal('publications', ['Genre'])

        # Adding model 'Publication'
        db.create_table('publications_publication', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('search_index', self.gf('fts.backends.pgsql._VectorField')(null=True)),
            ('gen', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['publications.Genre'], null=True, blank=True)),
            ('oauthors', self.gf('django.db.models.fields.TextField')(blank=True)),
            ...
            ('conference', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('other', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('year', self.gf('django.db.models.fields.SmallIntegerField')(max_length=4)),
        ...
        db.create_unique('publications_publication_authors', ['publication_id', 'member_id'])


    def backwards(self, orm):
        # Deleting model 'Genre'
        db.delete_table('publications_genre')
