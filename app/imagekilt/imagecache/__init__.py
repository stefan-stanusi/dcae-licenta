...
from imagekilt.imagecache.base import InvalidImageCacheBackendError, PessimisticImageCacheBackend, NonValidatingImageCacheBackend
...
def get_default_image_cache_backend():
    ...
    if not _default_image_cache_backend:
        ...
        import_path = settings.IMAGEKILT_DEFAULT_IMAGE_CACHE_BACKEND
        try:
